...
export const templateConfigValidator = v.object({
  ...
  includeVocab: v.boolean(),
  vocabLabel: v.string(),
  vocabStyle: fontStyleValidator,
  vocabPrefix: v.string(),
  vocabSuffix: v.string(),
  includeQuote: v.boolean(),
  quoteLabel: v.string(),
  quoteStyle: fontStyleValidator,
  quotePrefix: v.string(),
  quoteSuffix: v.string(),
